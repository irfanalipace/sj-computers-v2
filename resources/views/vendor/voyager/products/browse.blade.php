...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        <a title="NewsLetter" class="btn btn-sm btn-success view" id="send_news_letter" style="margin-right: 5px;">
            <i class="icon voyager-file-text"></i> <span class="hidden-xs hidden-sm">Send NewsLetter</span>
        </a>
...
@section('javascript')
    ...
    <script>
        ...
        $('#send_news_letter').click(function() {
            var ids = [];
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    toastr.success('Successfully send mail to customer"');
