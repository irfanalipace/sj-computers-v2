...
const ReviewsDialog = ({
    ...
    const { data, loading, error, } = useSpecificReview(reviewCardId, reviews);  // the purpose of passing the reviews is to check the data if its already present in the props 
