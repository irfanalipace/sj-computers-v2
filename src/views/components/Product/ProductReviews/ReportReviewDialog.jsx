      ...
      <FormControl sx={{ px: 3 }}>
        ...
        <FormGroup>
          <FormControlLabel
            ...
            label={
              <CheckBoxLabel title={'Off topic'} desc='Not about the product' />
            }
          />
          <FormControlLabel
            sx={{ mb: 1.5 }}
          ...
          <FormControlLabel
            ...
            label={
              <CheckBoxLabel title={'Fake'} desc='Paid for, inauthentic' />
            }
          />
          ...
          <FormControlLabel
            ...
            label={<CheckBoxLabel title={'Other'} desc='Something else' />}
          />
        </FormGroup>
      </FormControl>
      <Box sx={{ px: 3, mb: 3 }}>
