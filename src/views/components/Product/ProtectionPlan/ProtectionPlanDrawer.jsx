                ...
                {learnMore?.value === PLAN_ENUM.THREE_YEAR.value && (
                    <div className="accordion-content">
                        ...
                        <p className="details-of-protection">
                            ...
                            labor and shipping included. <br />
                            COVERAGE: Plan starts on the date of purchase.
                            Malfunctions covered after the manufacturer's
                            warranty. Power surges covered from day one. <br />
                            EASY CLAIMS PROCESS: File a claim anytime online at{" "}
                            <Link>www.cs@sjcomputersmn.com</Link> or by phone at
                            952-452-8884. Most claims are approved within
                            minutes. <br />
                            EXPERT TECH HELP: Real experts are available 24/7 to
                            help with set-up, connectivity issues,
                            troubleshooting and much more. <br />
                            TERMS & DETAILS: SJ Computers will also email your
                            plan confirmation with Terms & Conditions to the
                            address associated with your SJ Computers account
                            within 24 hours of purchase (if you do not see this
                            email, please check your spam folder). Contact us if
                            you cannot locate your plan confirmation and Terms &
                            Conditions via email at{" "}
                        ...
                        <h6 style={{ color: "#3bc4f1" }}>
                            SJ Computers covers the following malfunctions in
                            its products
                        </h6>
                        <ul>
                            <li
                            ...
                            >
                                ...
                                Because the battery is not new, it may not keep
                                a charge as well as a fresh one, resulting in
                                shorter use durations between charges. 
                            </li>
                            <li
                                style={{
                                    fontSize: "small",
                            ...
                            >
                                ...
                                Refurbished machines may still have original
                                hard drives, which may be nearing the end of
                                their lives and hence more likely to fail.  
                            </li>
                            <li
                                style={{
                                    fontSize: "small",
                            ...
                            >
                                ...
                                Because of prior usage, the cooling system
                                (fans, heat sinks) may be less effective,
                                leading the computer to overheat more
                                frequently.   
                            </li>
                            <li
                                style={{
                            ...
                            >
                                ...
                                While not a defect, refurbished computers might
                                display more scars or wear and tear than new
                                models.   
                            </li>
                            <li
                                style={{
                            ...
                            >
                                ...
                                Previous use might cause less reactive keys or
                                touchpad difficulties.   
                            </li>
                            <li
                                style={{
                                    fontSize: "small",
                            ...
                            >
                                ...
                                HDMI, USB, and various other ports could have
                                loose connections or damages from past use,
                                resulting in connectivity difficulties.   
                            </li>
                            <li
                                style={{
                                    fontSize: "small",
                            ...
                            >
                                ...
                                Screen difficulties, including dead pixels or
                                backlight issues, are prevalent, particularly if
                                the display was not changed throughout the
                            ...
                            >
                                ...
                                There may be outstanding software issues or
                                obsolete drivers that were not entirely resolved
