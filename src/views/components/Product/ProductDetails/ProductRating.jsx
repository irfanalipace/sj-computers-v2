...
export default function ProductRating({
  ...
  useEffect(() => {
    if (open) {
      const statisticsFromStore = reviewState.reviews?.product_stats?.statistics
  ...
  return (
    <Stack
      ...
      <Tooltip
        ...
        title={
          <>
            <RatingDetails loading={loading} productDetails={productDetails} />
            <Stack mt={2} spacing={2}>
              ...
              />
              <Button href='#reviews' endIcon={<ChevronRightIcon />}>
