  ...
  let renderRangeSliders = category => {
    return (
      <div>
        ...
        {filters[category]?.least_GB && filters[category]?.highest_GB ? (
          <div className='my-2  filter-value'>
            <label className='radio-container' htmlFor={category + 'GB'}>
              <input
                type='radio'
                value='GB'
                id={category + 'GB'}
                ...
                onChange={e => handleRangeUnit(category, 'GB')}
              />
              <span className='radiomark '></span>
              GB
            </label>
        ...
        <div className='filter-button-category-page'>
          <Button isLoading={isLoading} onClick={e => applyRange(e, category)}>
            Apply
          </Button>
        </div>
      </div>
