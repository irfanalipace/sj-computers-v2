        ...
        <div>
            {list?.map((order, index) => (
                <div key={index}>
                        ...
                        <div className="d-flex">
                            <FormControl fullWidth>
                                <textarea
                                    ...
                                    color="success"
                                    value={
                                        submitRequestOrderList[index]?.reasons
                                    }
                                    onChange={(e) =>
                    ...
                    {submitRequestOrderList[index]?.refund_type ===
                        "partial" && (
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <FormControl>
                                <TextField
                                    ...
                                    type="number"
                                    value={
                                        submitRequestOrderList[index]?.amount
                                    }
                                    onChange={(e) => {
                                        handleRequestOrderListChange(
                                            index,
            ...
            {isSubmitDisabled && (
                <p className="fs-6 text-danger mt-2">
                    *Please fill all the required fields to submit refund
                    request.
                </p>
            )}
        </div>
