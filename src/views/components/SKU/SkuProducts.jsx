      ...
      <div className='product-info py-4'>
        ...
        <div className='search-input-sku'>
          <form onSubmit={handleSearch}>
            <FormControl className='search-field' sx={{ m: 1, minWidth: 300 }}>
              <TextField
                id='outlined-basic'
                label='Search by name'
                variant='outlined'
            ...
            <button className='sku-form-btn ms-3' onClick={downloadProducts}>
              {downloadingProducts ? <Loader /> : ' Download Products'}
            </button>
          </form>
        </div>
