            ...
            <div className='sku-main-dev-button'>
              ...
              >
                <input
                  ...
                  onChange={_ => setholdQuantity(_.target.value)}
                />
              </div>
              ...
              <>
                {invent?.id ? (
                  <>
                        ...
                        {data.map((row, index) => (
                          <div className='table' key={index}>
                            <div className='sku-table-cell'>
                              <div className='sku-table-headers'>#ID</div>
                              <div className='sku-table-data'>{row.id}</div>
                            </div>
                            <div className='sku-table-cell'>
                              <div className='sku-table-headers'>Name</div>
                              <div className='sku-table-data'>{row.name}</div>
                            </div>
                            <div className='sku-table-cell'>
                              <div className='sku-table-headers'>ASIN</div>
                              <div className='sku-table-data'>{row.asin}</div>
                            </div>
                            <div className='sku-table-cell'>
                              <div className='sku-table-headers'>SKU</div>
                              <div className='sku-table-data'>{row.sku}</div>
                            </div>
                            <div className='sku-table-cell'>
                    ...
                    <button onClick={handleBuy} className='buy-now-button-sku'>
                      Clear
                    </button>{' '}
                  </>
                ) : (
