        ...
        <Container>
            ...
            <Row>
                <Col xs={6} sm={6} md={6} lg={6} xl={6}>
                    <img src={images[2]} alt="Image 2" className="dynamic-image" style={{height:'300px'}}/>
                    <p>Product Name</p>
                </Col>
                <Col xs={6} sm={6} md={6} lg={6} xl={6}>
                    <img src={images[1]} alt="Image 2" className="dynamic-image" style={{height:'100px'}}/>
                    <p>Lorem Ipsum | up to 30% off</p>
                    <img src={images[0]} alt="Image 2" className="dynamic-image" style={{height:'155px'}}/>
                    <p>Product Name</p>
                </Col>
