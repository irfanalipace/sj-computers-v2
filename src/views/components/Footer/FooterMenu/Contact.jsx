      ...
      <div className='contact-header'>
              ...
              <div className='col-md-12 col-lg-12 col-sm-12'>
                <div className='p-tages-text-contact'>
                  <h4 className='contact-text-home'>
                    Welcome to SJ Computer Customer Service, {user?.name}
                  </h4>
                  <h6 className='contact-text-home2'>
                    What would you like help with today? You can quickly take
                    care of most things here, or connect with us when needed.
                  </h6>
                </div>
              </div>
            </div>
        ...
        <div className='container image-cotact-container'>
          ...
          <div className='row'>
            ...
            <div className='col-lg-6'>
              <form className='contact-form-space' onSubmit={handleSubmit}>
                <h5 className='this-form-heading-contact'>leave a message</h5>
                <p className='pa-form-heading-contact'>
                  Write to us if you have any questions, we will <br></br>
                ...
                <div className='form-group text-group-input-contact'>
                  ...
                  />
                  {error.name && (
                    <p className='fs-6 mt-1 text-danger'>{error.name}</p>
                  )}
                </div>
                <div className='form-group text-group-input-contact'>
                  <input
                  ...
                  />
                  {error.email && (
                    <p className='fs-6 mt-1 text-danger'>{error.email}</p>
                  )}
                </div>
                <div className='form-group text-group-input-contact'>
                  <textarea
                  ...
                  ></textarea>
                  {error.message && (
                    <p className='fs-6 mt-1 text-danger'>{error.message}</p>
                  )}
                </div>
                <button
                  isLoading={isLoading}
