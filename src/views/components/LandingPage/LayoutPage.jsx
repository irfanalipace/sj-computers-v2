                  ...
                  <Link className='text-decoration-none text-black'>
                    <div className='layout-page-secetion-card'>
                      ...
                      <p className='pagarph-data-layout-page'>
                        HP 800 G2 Gaming RGB Desktop Computer PC - Intel Core i7
                        6th Gen, 32GB DDR4 Ram, 1TB SSD, GeForce GTX HP 800 G2
                        Gaming RGB Desktop Computer PC HP 800 G2 Gaming RGB
                        Desktop Computer PC - Intel Core i7 6th Gen, 32GB DDR4
                        Ram, 1TB SSD, GeForce GTX HP 800 G2 Gaming RGB Desktop
                        Computer PC HP 800 G2 Gaming RGB Desktop Computer PC -
                        Intel Core i7 6th Gen, 32GB DDR4 Ram, 1TB SSD, GeForce
                        GTX HP 800 G2 Gaming RGB Desktop Computer PC HP 800 G2
                        Gaming RGB Desktop Computer PC - Intel Core i7 6th Gen,
                        32GB DDR4 Ram, 1TB SSD, GeForce GTX HP 800 G2 Gaming RGB
                        Desktop Computer PC
                      </p>
                      <div className='data-start-dollar-ratin-dev'>
                        <div className='right-side-pric-sub-price-item'>
                          ...
                          <span className='div-red-value-items'>/</span>
                          <span className='sub-value-price-list'>$32342</span>
                        </div>
