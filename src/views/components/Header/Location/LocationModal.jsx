      ...
      <Modal.Body>
        ...
        <div>
          ...
          <Dropdown className='font-size-dialog-box-locations'>
            ...
            >
              {state?.name || currentState?.name || 'Select State'}
            ...
            <Dropdown.Menu className=''>
              {states.map(state => (
                <Dropdown.Item
                  ...
                  key={state.id}
                >
                  <h6 className='text-capitalize'>{state.name}</h6>
                </Dropdown.Item>
              ))}
            </Dropdown.Menu>
          </Dropdown>
          {errorMessage && (
            <p
              ...
              className='error-message-location-model2'
            >
              {errorMessage}
            </p>
          )}
            ...
            <div>
              {/* {errorMessage && (
                <p
                  ...
                  className="error-message-location-model"
                >
                  {errorMessage}
                </p>
              )} */}
