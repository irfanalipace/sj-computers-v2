            ...
            <div className='row py-sm-5'>
              <div className='col-12 col-sm-6 col-md-9'>
                <div className='p-tages-text-career px-sm-0 px-2'>
                  <h4 className='career-text-home'>Careers</h4>
                    ...
                    <div className='card-body body-card-career-page-sj'>
                        ...
                        <div className='col-md-6 d-flex flex-column justify-content-between'>
                          <div className='text-end mb-3'>
                            <div className='fs-6 fw-light posted-option-updated'>
                              Posted{' '}
                              {convertDateToLongFormat(career?.created_at)}
                            </div>
                            <div className='text-muted fs-6 fw-light updated-posted-career-data'>
                              Updated{' '}
                              {convertDateToLongFormat(career?.updated_at)}
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className='read-button-job-descriptions'>
                        <span className=' mb-0 text-capitalize descriptions-paragraph-data description-text'>
                          ...
                          career.job_description.length > 270
                            ? // Display only the first 100 characters of the job description
                              `${career.job_description.substring(0, 270)}...`
