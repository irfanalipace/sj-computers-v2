...
const OrderPage = () => {
  ...
  const renderTabContent = () => {
    if (activeTab === 0) {
      return (
        <OrderCard data={dummyDataForOrders} />
      );
    } else if (activeTab === 1) {
        return (
            <OrderCard data={dummyDataForCancelledOrders} />
      );
    }
  };
    return (
                ...
                <div className="row mx-0">
                            ...
                            <div style={{ display: 'flex' }}>
                                <input
                                    ...
                                    className={orderSearch ? 'search-input green' : 'search-input'}
                                />
                  ...
                  <div className="row ">
                    ...
                    <div style={{display : 'flex' , marginTop: 40, marginBottom: 40}}>
                        <p className="orderType">{} {activeTab === 0 ? `${dummyDataForOrders.length} orders` : `${dummyDataForCancelledOrders.length} cancelled order`} place in</p> 
                    ...
                    <div style={{marginTop: '15%'}}className="col-sm-6 col-md-4 col-4">   
