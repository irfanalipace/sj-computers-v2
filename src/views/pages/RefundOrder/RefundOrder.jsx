...
export default function RefundOrder() {
        ...
        <div className='d-flex'>
          <FormControl fullWidth>
            <TextField
              ...
              onChange={e => {
                setUsersData(selectedUserType, 'email', e?.target?.value);
              }}
              InputProps={{
                endAdornment: (
  ...
  const OTPVerficationJSX = useMemo(() => {
    const JSX = (
      <>
        <p className='my-3 fw-medium'>
          We’ve sent a 4 digits code to {USERS_DATA[selectedUserType]?.email},
        ...
        <div className='d-flex'>
              ...
              <TextField
                ...
                onChange={e => {
                  ...
                  if (value === '' || otpRegex.test(value)) {
                    setUsersData(selectedUserType, 'otp', value.slice(0, 4));
                  }
                }}
              />
            </FormControl>
          ...
          <div className='align-items-center d-flex ms-2'>
            <button
              ...
              disabled={
                isLoading || USERS_DATA[selectedUserType]?.otp?.length < 4
              }
            >
              ...
              <div className='order-type-btns mb-4'>
                <div className='d-flex flex-sm-row flex-column align-items-center'>
                  <button
                    ...
                    onClick={() => setSelectedUserType(USER_TYPE_ENUM.CUSTOMER)}
                  >
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSelectedUserType(USER_TYPE_ENUM.SALE_PERSON)
                    }
                  >
