...
const BannerCategory = () => {
  ...
  const featuredItems = [
    ...
    },
    {
      // image: image3,
      image:
        'https://bto.us/cdn/shop/files/BTO-logo.webp?v=1704702209&width=110',
  ...
  const networkItems = [
    {
      // image: linkrouter,
      image:
        'https://files.refurbed.com/ii/dell-optiplex-7050-sff-1673339333.jpg',
    ...
    },
    {
      // image: modem,
      image:
        'https://www.mbcommunication.com.pk/4802-large_default/intel-nt12.jpg',
    ...
    },
    {
      // image: modem,
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNwOXf3PYGYs7LceVZxSEPVUEI1Pp8gpQaJukhqYONUw&s',
  ...
  const upgradecomputers = [
    ...
    },
    {
      // image: img2,
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFLacq8lq418sCgcdCPAg98-8cZC7CEF03Ug&s',
      categoryLink: '/category/laptops',
    ...
    },
    {
      // image: img3,
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRu3npkk2sLCcFmZfTFKP8XKz62_DwfLLqGeIPcMzlQ2A&s',
      categoryLink: '/category/desktop',
    ...
    },
    {
      // image: img1,
      image:
        'https://mms.businesswire.com/media/20151020006538/en/492013/5/Dell-OptiPlex-family.jpg',
      categoryLink: '/category/gaming_desktops',
      categoryName: 'Full Size',
    },
  ];
