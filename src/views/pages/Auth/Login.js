        ...
        <div className="row">
          ...
          <form className="auth-inner-body">
            ...
            <div className="mb-3">
              ...
              />
              {error && <p className="text-danger">Email Does Not Exist</p>}
            </div>
            <div className="d-grid">
              <button type="submit" className="btn btn-primary login-button" onClick={verifyEmailFunction} disabled={isLoading}>
