      ...
      <div className={`container form-container`} onSubmit={handleSubmit}>
        <div className='row'>
          ...
          <form className={`auth-form ${mounted && 'slide'} `}>
            ...
            <div className='mb-3'>
              <label className='password-label '>Enter your Email</label>
              <input
                type='email'
                name='email'
            ...
            <div className='mb-3'>
              ...
              />
              {fieldErrors && (
                <p className='fs-6 mt-1 text-danger'>{fieldErrors.password}</p>
              )}
            </div>

            <div className='mb-3'>
              <label className='password-label '>Re-enter your password</label>
              <input
                type='password'
