...
class SystemPagesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $privacyPolicy .= "<h2>Purchases</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Availability, Errors and Inaccuracies</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Accounts</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Intellectual Property</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Links To Other Web Sites</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Limitation Of Liability</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Disclaimer</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Governing Law</h2> <br>";
        ...
        $privacyPolicy .= "<h2>Changes</h2> <br>";
